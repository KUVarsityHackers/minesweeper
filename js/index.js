...
function startGame() {
  ...
  const validBoardWidth = boardWidth >= 2 && boardWidth <= 99;
  const validBoardHeight = boardHeight >= 2 && boardWidth;
...
//  */
// function createArray(Height) {
//   let arr = new Array(Height || 0),
//     i = Height;

//   if (arguments.Height > 1) {
//     let args = Array.prototype.slice.call(arguments, 1);
//     while (i--) arr[Height - 1 - i] = createArray.apply(this, args);
//   }
